...
# must not be able to spawn an unbounded tree of deeper work (Umbrella 2026-06-14).
...
# decomposes recursively is this codebase's founding defect class (Umbrella 2026-06-14),
...
# `acme-code`, `gpu.cuda`. The pattern exists because this is a MATCHING
...
class Beads:
    ...
    def claim(
        ...
        **The gate fails closed.** ``capabilities=None`` is not "skip the
        ...
        seeing Acme work in its portfolio, because a lane that disappears
