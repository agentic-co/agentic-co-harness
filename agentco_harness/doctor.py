...
skim it. Designed 2026-08-08, shipped after the 8h30m Umbrella outage that a
...
killed the Umbrella deployment — a source was promised in config, the loop
...
def collect(config_path: str) -> DoctorReport:
    ...
    if not children and not any(
        ...
        # the BROKEN definition — it is the portfolio-scale form of the Umbrella
    ...
    # class as the Umbrella defect. If nothing routes to codex, there is nothing
    ...
    # beads apiece. That is the globexapp box-scout incident (2026-07-22,
