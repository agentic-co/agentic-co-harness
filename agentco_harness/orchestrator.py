...
class Orchestrator:
    ...
    def _external_agent(self, name: str | None) -> bool:
        ...
        Such beads belong to an out-of-band worker (e.g. globexapp's
        ...
        failing them — on 2026-07-22 and 2026-07-29 the globexapp cycle
    ...
    def cycle(
        ...
        # signal — 37 stale `verify-globexapp` failures were sitting at the top of
        ...
        # beads plus an RCA bead apiece: the globexapp box-scout incident
    ...
    def _execute_task(self, task: Task) -> bool:
        ...
        forever at zero token cost with ``error: None``. On the globexapp node
